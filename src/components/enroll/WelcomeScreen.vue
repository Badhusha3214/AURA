        ...
        <div class="relative p-4 w-full max-w-md max-h-full">
            ...
            <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                ...
                <div class="flex items-center justify-between p-4 md:p-5 border-b rounded-t dark:border-gray-600">
                    <h3 class="text-xl font-semibold text-gray-900 dark:text-white">{{ mode === 'enroll' ? 'Create Account' : 'Sign In' }}</h3>
                ...
                <div class="p-4 md:p-5 space-y-4">
                    ...
                    <div class="flex flex-col items-center justify-center gap-2">
                        ...
                        <span class="text-xs text-black-500">Empower your cycle, embrace your flow. Welcome back to your period journey.</span>
                    </div>

                    <button @click="getUserLogin" type="button"
                        class="w-full text-white font-medium rounded-lg text-sm px-5 py-2.5 text-center"
                        :class="{ 'bg-pink-500 hover:bg-red-400': enableButton, 'bg-gray-300 cursor-not-allowed': !enableButton }"
