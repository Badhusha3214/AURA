<template>
  <div v-if="doctors.length > 0">
   <div v-for="doctor in doctors" :key="doctor.id">
     ...
     <div
       class="max-w-sm p-6 mb-4 bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700 flex flex-col justify-between"
     >
       <div>
         <a href="#">
           <h5
 ...
 <div v-else class="flex justify-center items-center h-screen m-4">
