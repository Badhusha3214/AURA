<template>
    ...
    <div
      ...
      <div class="flex my-4">
        <div class="flex items-center  mx-12">
          ...
          <label for="inline-radio" class="ms-2 text-sm font-medium text-gray-900 font-semibold dark:text-gray-300">Vedio Call</label>
        </div>
        <div class="flex items-center mx-10">
          <input id="inline-2-radio" type="radio" value="" name="inline-radio-group"
            class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600">
          <label for="inline-2-radio" class="ms-2 text-sm font-medium text-gray-900 font-semibold dark:text-gray-300">Audio Call</label>
        </div>
      </div>
  ...
  <div class="max-w-[8rem]">
    <label for="time" class="block mb-2 text-sm font-medium text-gray-900 font-bold dark:text-white font-semibold">Select time:</label>
    <div class="relative">
